          ...
          >
            {[
              ...
              },
              {
                ...
                items: ["React.js","Node.js","Express.js","MongoDB","JavaScript"],
                cols: "grid-cols-2"
              },
              {
              ...
              {
                title: "Soft Skills",
                items: ["Problem Solving","Team Collaboration","Time Management","Quick Learner"],
                cols: "grid-cols-1"
              }
            ].map((section, i) => (
              <motion.div
          ...
          >
            {certificates.map((cert, index) => (
              <motion.div
                ...
                variants={cardVariants}
                whileHover={hoverEffect}
                className="bg-[#C19474] p-2 rounded-xl flex flex-col items-center justify-start cursor-pointer shadow-lg border border-transparent"
